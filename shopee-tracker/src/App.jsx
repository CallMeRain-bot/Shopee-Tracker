...
function App() {
    ...
    const handleAddCookie = async () => {
        ...
        try {
            await api.addCookie(newCookie.trim(), false); // Luôn thêm vào hàng chờ (pending)
            setNewCookie('');
                                                                    ...
                                                                    <div className="order-card-info-row">
                                                                        ...
                                                                        <div className="info-column status-column">
                                                                            <div className="info-group">
                                                                                ...
                                                                                <div className="inline-status-info">
                                                                                    <span className="material-symbols-outlined info-icon">info</span>
                                                                                    <span className="status-text">{order.status || 'Đang xử lý đơn hàng'}</span>
                                                                                </div>
                                                                            </div>
                                                                            {order.status_time && (
                                                                                <div className="info-group">
                                            ...
                                            return (
                                                <div className="recent-update-card">
                                                    ...
                                                    <div className="recent-update-body">
                                                        <h3>{latestOrder.product || 'Unknown Product'}</h3>
                                            ...
                                            orders.slice(0, 5).map((order, idx) => (
                                                <div className="mobile-order-card" key={order.id || idx}>
                                                    ...
                                                    <div className="mobile-order-info">
                                                        <h4>{order.product || 'Unknown Product'}</h4>
                ...
                <div className="modal-overlay" onClick={() => setShowAddModal(false)}>
                    <div className="modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <p className="modal-hint">
                            ⏳ Cookie sẽ được thêm vào hàng chờ. Scheduler tự động check mỗi 5 phút.
                        </p>
